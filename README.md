...
```bash
/plugin marketplace add git@github.com:MaxBoiko21/claude-plugins-marketplace.git
```
...
```bash
/plugin install lyra@own-plugins-marketplace
```

Install a specific agent:
```bash
/plugin install accessibility-expert@own-plugins-marketplace
```
